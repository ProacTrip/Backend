...
func TestSentinelErrors_Format(t *testing.T) {
	errs := map[string]error{
		...
		"ErrInvalidOCRStatus":        ErrInvalidOCRStatus,
...
func TestSentinelErrors_Count(t *testing.T) {
	...
	allErrors := []error{
		...
		ErrNotifPrefsNotFound, ErrInvalidGender,
		...
		ErrInvalidCurrencyCode, ErrInvalidTimezone, ErrEncryptionFailed,
		ErrDecryptionFailed, ErrDocumentNotFound, ErrInvalidDocumentType,
		ErrInvalidOCRStatus, ErrInvalidFileType, ErrFileTooLarge,
