// Handler HTTP para POST /v1/user/saved-searches.
...
// Handler procesa POST /v1/user/saved-searches.
type Handler struct {
	usecase *UseCase
}
...
// Handle bindea el JSON, sobreescribe UserID con los claims y crea la búsqueda.
