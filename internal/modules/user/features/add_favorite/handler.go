// Handler HTTP para POST /v1/user/favorites.
...
// Handler procesa POST /v1/user/favorites.
type Handler struct {
	usecase *UseCase
}
...
// Handle bindea el JSON, sobreescribe UserID con los claims y crea el favorito.
